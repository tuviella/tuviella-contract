...
module.exports = async function (deployer, network, accounts) {
  ...
  if(network === 'development'){
    ...
    await deployer.deploy(Staking, tvt.address, tvt.address, accounts[0] , 1000, 0);

  }else{
    await deployer.deploy(TuviellaToken, '0x65cc85C1D3C2d0ADF0641e19Ab98edcc25A9C22B');
    tvt = await TuviellaToken.deployed();
    await deployer.deploy(Staking, tvt.address, tvt.address, '0x65cc85C1D3C2d0ADF0641e19Ab98edcc25A9C22B', 1000, 0);
  }
